...
_*Organized list of open-source projects sorted alphabetically._
...
| Project Name | Description | Author | Status | Latest Version |
|-------------|-------------|--------|--------|----------------|
 **[JammBox](https://github.com/KerHack-Libre/JammBox)** | A collection of classic DOS games, already configured to work easily with DOSBox, via a lightweight user interface (TUI). | **[@KerHack-Libre](https://github.com/KerHack-Libre)** | ![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg?style=flat-square)| [![Project Version](https://img.shields.io/badge/Version-1.0-brightgreen.svg?style=flat-square)](https://github.com/KerHack-Libre/JammBox/releases/tag/v1.0)|
